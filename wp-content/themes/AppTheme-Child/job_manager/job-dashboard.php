<div id="job-manager-job-dashboard">
	<p><?php _e( 'Your chores can be viewed, edited and managed below. All applications can be accessed here as well!', 'wp-job-manager' ); ?></p>
										...
										<?php
											...
											switch ( $job->post_status ) {
												...
												case 'expired' :
													...
													//else ( job_manager_get_permalink( 'submit_job_form' ) ) {
											...
											//$actions['delete'] = array( 'label' => __( 'Delete', 'wp-job-manager' ), 'nonce' => true ); //removed the delete option
	...
	<p><?php _e( '<a href="/pick-a-chore/" class="button">Post New Chore</a>', 'wp-job-manager' ); ?></p>
</div>