...
function buddyboss_scripts_styles()
{
	 ...
	 */
	if ( !is_admin() ) {
		wp_enqueue_script( 'buddyboss-main', get_template_directory_uri().'/js/buddyboss.js', array( 'jquery' ), '4.2.0' );
	}
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_style( 'buddyboss-wp-frontend', get_template_directory_uri().'/css/wordpress.css', array( 'fontawesome', 'googlefonts' ), '4.2.0', 'all' );
	}
	...
	*/
	if ( $buddyboss->buddypress_active && !is_admin() )
	{
		...
		wp_enqueue_style( 'buddyboss-bp-frontend', get_template_directory_uri().'/css/buddypress.css', array( 'fontawesome', 'googlefonts' ), '4.2.0', 'all' );
	}
