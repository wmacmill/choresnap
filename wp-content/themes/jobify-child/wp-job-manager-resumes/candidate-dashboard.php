...
<div id="resume-manager-candidate-dashboard">
	<p><?php echo _n( 'Your profile can be viewed, edited or removed below.', 'Your profile(s) can be viewed, edited or removed below.', resume_manager_count_user_resumes(), 'wp-job-manager-resumes' ); ?></p>
