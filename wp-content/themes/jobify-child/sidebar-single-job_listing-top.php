		...
		<div class="col-md-<?php echo $colspan[ $i - 1 ]; ?> col-sm-6 col-xs-12">
			...
			<?php if ( ! is_active_sidebar( 'single-job_listing-top-' . $i ) ) : ?>
				...
				<?php if ( 1 == $i ) : ?>
					...
					<?php echo do_shortcode('[gmw_single_location map="1" map_width="100%" map_height="250px" additional_info="0" directions="0"]'); ?>
					<?php echo '<div id="listing-map-styling" style="font-size:smaller">Location is approximate</div>'?>
