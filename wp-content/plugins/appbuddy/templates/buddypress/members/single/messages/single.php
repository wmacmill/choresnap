		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php if ( !bp_get_the_thread_recipients() ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'appbuddy' ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'appbuddy' ), bp_get_the_thread_recipients() ); ?>

				<?php endif; ?>

			</span>

			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php esc_attr_e( "Delete Message", "appbuddy" ); ?>"><?php _e( 'Delete', 'appbuddy' ); ?></a> &nbsp;
		</p>
			...
			<div class="message-box">
				...
				<div class="message--rply-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'appbuddy' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php esc_attr_e( 'Send Reply', 'appbuddy' ); ?>" id="send_reply_button"/>
					</div>
