...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	...
	<div class="acomment-meta">
		...
		printf( __( '<a href="%1$s">%2$s</a> replied <a href="%3$s" class="activity-time-since"><span class="time-since">%4$s</span></a>', 'appbuddy' ), bp_get_activity_comment_user_link(), bp_get_activity_comment_name(), bp_get_activity_comment_permalink(), bp_get_activity_comment_date_recorded() );
		?>
	</div>
	...
	<div class="acomment-options">
		...
		<?php if ( bp_activity_user_can_delete() ) : ?>
			...
			<a href="<?php bp_activity_comment_delete_link(); ?>" class="delete acomment-delete confirm bp-secondary-action" rel="nofollow"><?php _e( 'Delete', 'appbuddy' ); ?></a>
