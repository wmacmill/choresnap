 /*!
 * Thumbnail helper for soliloquybox
 * version: 1.0.7 (Mon, 01 Oct 2012)
 * @requires soliloquybox v2.0 or later
 *
 * Usage:
 *     $(".soliloquybox").soliloquybox({
 *         helpers : {
 *             thumbs: {
 *                 width  : 50,
 *                 height : 50
 ...
 */
;(function ($) {
	//Shortcut for soliloquybox object
	var F = $.soliloquybox;
	...
	F.helpers.thumbs = {
		...
		init: function (opts, obj) {
			...
			for (var n = 0; n < obj.group.length; n++) {
				list += '<li><a style="width:' + thumbWidth + 'px;height:' + thumbHeight + 'px;" href="javascript:jQuery.soliloquybox.jumpto(' + n + ');"></a></li>';
			}

			this.wrap = $('<div id="soliloquybox-thumbs"></div>').addClass(opts.position).appendTo('body');
