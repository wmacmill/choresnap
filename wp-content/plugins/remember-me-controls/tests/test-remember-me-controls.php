...
//		$this->set_option();
	...
	function test_get_version() {
		$this->assertEquals( '1.5', c2c_RememberMeControls::get_instance()->version() );
	}
	...
	function test_hooks_action_auth_cookie_expiration() {
	...
	function test_auth_cookie_expiration_remember_me_forever_has_priority_over_remember_me_duration() {
		$this->set_option( array( 'remember_me_forever' => true, 'remember_me_duration' => 200 ) );
		$this->assertEquals( 100 * YEAR_IN_SECONDS, c2c_RememberMeControls::get_instance()->auth_cookie_expiration( 456, 1, true ) );
	}

	function test_auth_cookie_expiration_if_remember_me_duration() {
	...
	function test_auth_cookie_expiration_remember_me_duration_does_not_exceed_max() {
		$this->set_option( array( 'remember_me_duration' => 24 * 365 * 101 ) ); // 101 years
		$this->assertEquals( 100 * YEAR_IN_SECONDS, c2c_RememberMeControls::get_instance()->auth_cookie_expiration( 456, 1, true ) );
	}

	function test_auth_cookie_expiration_remember_me_duration_of_0_result_in_default_expiration() {
	...
	function test_auth_cookie_expiration_if_remember_unchecked_and_disable_remember_me() {
		$this->set_option( array( 'disable_remember_me' => true ) );
		$this->assertEquals( 48 * HOUR_IN_SECONDS, c2c_RememberMeControls::get_instance()->auth_cookie_expiration( 456, 1, false ) );
	}

	function test_auth_cookie_expiration_if_remember_checked_and_disable_remember_me() {
		$this->set_option( array( 'disable_remember_me' => true ) );
		$this->assertEquals( 48 * HOUR_IN_SECONDS, c2c_RememberMeControls::get_instance()->auth_cookie_expiration( 456, 1, true ) );
	}

	function test_auth_cookie_expiration_if_remember_checked_that_disable_remember_me_has_top_priority() {
