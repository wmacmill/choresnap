...
function gmw_update_key_api_notices() {
	...
	return $messages = apply_filters( 'gmw_update_key_api_notices', array(
			'activate'				=> __( 'Please enter your license key and click "Activate License". The license key is required in order to receive automatic updated for the plugin.', 'GFG' ),
			'activated'				=> __( 'Your license for %s plugin successfully activated. Thank you for your support!', 'GFG' ),
			'deactivated'			=> __( 'Your license for %s plugin successfully deactivated.', 'GFG' ),
			'valid'					=> __( 'License is activated. Thank you for your support!', 'GFG' ),
			'no_key_entered'		=> __( 'No license key entered. Please enter the license key and try again.', 'GFG' ),
			'expired' 				=> __( 'Your license has expired. Please renew your license in order to keep getting its updates and support.', 'GFG' ),
			'no_activations_left' 	=> sprintf( __( 'Your license has no activations left. Click <a %s>here</a> to manager your license activations.', 'GFG' ), 'href="http://geomywp.com/purchase-history/" target="_blank"' ),
			'missing'				=> __( 'Something is wrong with the key you entered. Please verify the key and try again.', 'GFG' ),
			'retrieve_key'			=> sprintf( __( 'Lost or forgot your license key? <a %s >Retrieve it here.</a>', 'GFG' ), 'href="http://geomywp.com/purchase-history/" target="_blank"' ),
			'activation_error'		=> __( 'Your license for %s plugin could not be activated. See error message below!', 'GFG' ),
	) );
}
