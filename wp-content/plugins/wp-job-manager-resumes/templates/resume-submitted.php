...
switch ( $resume->post_status ) :
	...
	break;
	case 'pending' :
		printf( '<p class="resume-submitted">' . __( 'Resume submitted successfully. Your resume will be visible once approved.', 'wp-job-manager-resumes' ) . '</p>', get_permalink( $resume->ID ) );
	break;
	default :
